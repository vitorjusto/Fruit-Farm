...
export function ChangeBirdBranchUpgrade(dogManager, id)
{
	dogManager.BranchUpgradeId = id
	dogManager.BranchUpgrade = null;
...
export function GetBranchUpgradeCollection(id)
{
	if(id == 1)
		return new BranchUpgradeCollection(
								new BranchUpgrade(2, "More Bird", "Aumenta o espaço das frutas, porem os nerfs de fruta por aparição de climas são aumentados"),
								new BranchUpgrade(3, "More Bird", "Aumenta o preço de upgrades por frutas e o preço de venda de todas as frutas aumenta"),
